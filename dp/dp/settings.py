...
ALLOWED_HOSTS = ['dp.loc', 'localhost', '192.162.242.28', 'ducatoparts.tk', 'ducatoparts.ru','enginexpert.ru']
...
CRONJOBS = [
    ("0 1 * * *", "currency.cron.run_api", '>> /home/manhee/ducatoparts.ru/dp/currency/cron.log'),
]
